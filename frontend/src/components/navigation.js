    ...
    items: [
      {
        ...
        children: [
          ...
          { icon: FileCheck2, label: 'PDF Templates', section: 'Preferences', to: '/settings/pdf-templates', roles: ['TENANT_ADMIN', 'INVENTORY_MANAGER'], exact: true },
          { icon: Mail, label: 'Email Templates', section: 'Preferences', to: '/settings/email-templates', roles: ['TENANT_ADMIN', 'INVENTORY_MANAGER'], exact: true },
        ],
      },
    ],
  },
